...
public class Grafo {
    ...
    protected Grafo(String serieNodos) {
    ...
    public static Grafo getInstance() {
        if (instance == null) {
            return instance = new Grafo("");
       }
        return instance;
    }

    public ArrayList<String> getNombreRouters() {
        return nombreRouters;
    }

    public void setNombreRouters(ArrayList<String> nombreRouters) {
        this.nombreRouters = nombreRouters;
    }
    ...
    public void StringToChar(){
        this.primerUsuario = Arbol.getInstance().getUsuarioAux();
